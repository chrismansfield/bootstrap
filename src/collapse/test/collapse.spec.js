describe('collapse directive', function () {
    ...
    var scope, $compile, $timeout, $q, $browser;
    var element;

    beforeEach(module('ui.bootstrap.collapse'));
    beforeEach(inject(function (_$rootScope_, _$compile_, _$timeout_, _$q_, _$browser_) {
        scope = _$rootScope_;
        $compile = _$compile_;
        $timeout = _$timeout_;
        $q = _$q_;
    ...
    beforeEach(function () {
        ...
        $q.$createdObjects = [];
        $q.defer = function() {
            var deferred = $q.defer.$original();
            $q.$createdObjects.push(deferred);
            return deferred;
        };
        $q.$flush = function (data) {
            $q.$createdObjects.forEach(function (deferred) {
                deferred.resolve(data);
            });
            $browser.defer.flush();
        };
        $q.defer.$original = original;
    });
